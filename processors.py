...
class ProcessorOperating(me.EmbeddedDocument):
    ...
    define_operating_status = ["start", "starting", "running",
                               "stopping", "stop"]
...
class Processor(me.Document):
    ...
    operating = me.EmbeddedDocumentField("ProcessorOperating",
                                         required=True,
                                         default=ProcessorOperating)
...
class ProcessorCommand(me.Document):
    ...
    commanded_date = me.DateTimeField(required=True,
                                      default=datetime.datetime.now)
    processed_date = me.DateTimeField(required=True,
                                      default=datetime.datetime.now)
...
class ProcessorRunFail(me.Document):
    ...
    processor = me.ReferenceField("Processor", dbref=True)
    compute_node = me.ReferenceField("ComputeNode", dbref=True)
    reported_date = me.DateTimeField(required=True,
                                     default=datetime.datetime.now)
    processed_date = me.DateTimeField(required=True,
                                      default=datetime.datetime.now)
    message = me.StringField(required=True, default='')
